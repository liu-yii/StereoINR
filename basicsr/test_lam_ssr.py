...
def main(root_path, imgpath, img_path2, w=50, h=300, window_size=32, fold=50, sigma=1.2, l=9, alpha=0.3, zoomfactor=4, kde=False, output_dir="./visual"):
...
if __name__ == '__main__':
    ...
    main(root_path, imgpath="demo/demo2/lr0.png", img_path2="demo/demo2/lr1.png", output_dir="results")